...
## 🛠️ Стек технологий
* [cite_start]**Python 3.13**: Использование `Pandas` для обработки данных[cite: 1, 7].
* [cite_start]**Библиотеки**: `yfinance` для сбора, `Seaborn` и `Matplotlib` для визуализации[cite: 7].
